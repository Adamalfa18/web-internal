    ...
    <div class="container-fluid py-1 px-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">{{ request()->segment(1) }}</li>
            </ol>
            <h6 class="font-weight-bold mb-0">{{ request()->segment(1) }}</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item ps-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0">
                        <img src="{{ asset('storage/' . auth()->user()->logo) }}" class="avatar avatar-sm bg-gradient-dark me-3" alt="logo user login"> 
                    </a>
                </li>
            </ul>
        </div>
