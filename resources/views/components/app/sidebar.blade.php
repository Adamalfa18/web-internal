<aside class="sidenav navbar-style navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start "
    ...
    <div class="collapse navbar-collapse px-style  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ in_array(Route::currentRouteName(), ['divisi-sa.index']) ? 'active' : '' }}"
                    href="{{ route('divisi-sa.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link {{ in_array(Route::currentRouteName(), ['clients.index', 'clients.create', 'clients.edit', 'laporan-bulanan.index', 'laporan-bulanan.create', 'laporan-bulanan.edit', 'laporan-harian.index', 'laporan-harian.create', 'laporan-harian.edit']) ? 'active' : '' }}"
                    ...
                    <a class="nav-link {{ in_array(Route::currentRouteName(), ['acount.index', 'acount.create', 'acount.edit']) ? 'active' : '' }}"
                        ...
                        <div
                            ...
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>account</title>
                                <g id="account" stroke="none" stroke-width="1" fill="none"
                                    fill-rule="evenodd">
                                    <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                        fill-rule="nonzero">
                                        <path class="color-foreground"
