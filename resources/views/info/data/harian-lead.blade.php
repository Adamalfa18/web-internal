                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="spent"
                                                value="{{ $lead->spent }}" placeholder="Spent Target" readonly>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="click"
                                                value="{{ $lead->click }}" placeholder="Jumlah Click" readonly>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="note" rows="3" readonly>{{ $lead->note }}</textarea>
                                        </div>
                                    </div>
                                </div>
