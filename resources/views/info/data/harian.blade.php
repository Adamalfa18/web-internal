                                ...
                                <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                                    <form id="perPageForm" action="{{ route('laporan-harian.index') }}" method="GET"
                                        ...
                                        <select name="perPage"
                                            ...
                                            <option value="60" {{ request('perPage')==60 ? 'selected' : '' }}>60
                                            </option>
                                            <option value="80" {{ request('perPage')==80 ? 'selected' : '' }}>80
                                            </option>
                                                            ...
                                                            <div class="container">
                                                                <form>
                                                                    ...
                                                                    <div class="row topup-style">
                                                                        ...
                                                                        $item->google_gtm > 0 || $item->google_youtube >
                                                                        0 || $item->google_performance_max > 0)
                                                                        <div class="title-harian">
                                                                            <h5>Topup Google</h5>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="readonly-input">
                                                                                    Rp
                                                                                    {{
                                                                                    number_format($item->google_youtube,
                                                                                    0, ',', '.') }}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="readonly-input">
                                                                                    Rp
                                                                                    {{
                                                                                    number_format($item->shopee_manual,
                                                                                    0, ',', '.') }}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="readonly-input">
                                                                                    Rp
                                                                                    {{
                                                                                    number_format($item->shopee_auto_meta,
                                                                                    0, ',', '.') }}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                    ...
                    <div class="col-12">
                        <div class="card border shadow-xs mb-4 border-client">
                            <div class="card-header border-bottom pb-0 border-client-bottom">
                                <div class="d-sm-flex align-items-center">
                                    <div>
                                        <h6 class="font-weight-semibold text-lg mb-0">Daily Report Lead
                                        </h6>
                                        <p class="text-sm">List of daily report lead</p>
                                    </div>
                                    ...
                                    <div class="modal fade" id="addLaporanModal" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('data-client.laporan-harian.store-lead') }}"
                                                        method="POST">
                                                        @csrf
                                                        <div class="mb-3">
                            ...
                            <div class="card-body px-0 py-0">
                                ...
                                <div class="table-responsive p-0">
                                    @if ($leads->isEmpty())
                                    <p class="ntp">No lead data available.</p>
                                    @else
                                    <table class="table align-items-center mb-0">
                                        <thead class="bg-gray-100">
                                            <tr>
