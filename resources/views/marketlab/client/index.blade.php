                                ...
                                <div class="modal-body">
                                    ...
                                    <form class="form-marketing" action="{{ route('clients.store') }}" method="POST"
                                            ...
                                            <div class="col-md-6" style="display: none;">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check form-check-inline mt-2">
                                                        ...
                                                        <label class="form-check-label">{{ $layanan->nama_layanan
                                                            }}</label>
                                                    </div>
                                                    @endforeach
                                                </div>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="pegawai_id" class="form-label">PIC</label>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        ...
                                                        @case(3)
                                                        <span
                                                            class="badge badge-sm border border-danger text-danger badge-paid">Non-active</span>
                                                        @break
                                                        @endswitch
                                                    </td>
                        ...
                        <form class="form-marketing" action="{{ route('clients.update', $client->id) }}" method="POST"
                            ...
                            <div class="row mt-4">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="telepon_finance">
                                                            Finance Phone Number</label>
                                                        <input type="text"
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <label for="status_client">
                                                    Client Status</label>
                                                <select class="form-select" name="status_client" id="status_client"
                                                    aria-label="Default select example" required>
                                                    <option value="1" {{ $client->status_client == 1 ? 'selected' : ''
                                                        }}>Active
                                                    </option>
                                                    <option value="3" {{ $client->status_client == 3 ? 'selected' : ''
                                                        }}>Non-active
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea
                                                    class="form-control @error('informasi_tambahan') is-invalid @enderror"
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="col-md">
                                        <div class="form-group">
                                            <label for="gambar_client" class="form-label"> Brand Logo</label>
                            ...
                            <div class="mb-3" style="display: none;">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('layanan') is-invalid @enderror"
                                        ...
                                        in_array($layanan->id, old('layanan', $client->layanan->pluck('id')->toArray()))
                                    ? 'checked' : '' }}>
