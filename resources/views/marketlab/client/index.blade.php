            ...
            <div class="row">
                <div class="col-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea type="text" class="form-control" name="alamat" id="alamat"
                                                    placeholder="Jl. Summarecon Bandung....." rows="3"
                                                    required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="informasi_tambahan"
                                                    id="informasi_tambahan" placeholder="Note....." rows="3"
                                                    required></textarea>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <form id="filterForm" method="GET" class="d-flex m-3 gap-2">
                        ...
                        <input type="date" name="date_aktif" value="{{ request('date_aktif') }}" class="form-control">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        ...
                                                        @case(3)
                                                        <span
                                                            class="badge badge-sm border border-danger text-danger badge-paid">Tidak
                                                            Aktif</span>
                                                        @break
                                                        @endswitch
                                                    </td>
        ...
        <div class="modal fade" id="editClientModal{{ $client->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <!-- Akhir notifikasi error -->
                    <form class="form-marketing" action="{{ route('clients.update', $client->id) }}" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="nama_finance">Nama
                                        Finance</label>
                                    <input type="text" class="form-control @error('nama_finance') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('date_in') is-invalid @enderror"
                                            id="date_in" name="date_in" value="{{ old('date_in', $client->date_in) }}"
                                            required>
                                        @error('date_in')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="status_client" id="status_client"
                                        aria-label="Default select example" required>
                                        <option value="1" {{ $client->status_client == 1 ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="3" {{ $client->status_client == 3 ? 'selected' : '' }}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                        name="alamat">{{ old('alamat', $client->alamat) }}</textarea>
                                    @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input class="form-control @error('gambar_client') is-invalid @enderror" type="file"
                                        id="gambar_client" name="gambar_client" onchange="previewImage()">
                                    @error('gambar_client')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-3" style="display: none;">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('layanan') is-invalid @enderror" type="checkbox"
                                    name="layanan[]" value="{{ $layanan->id }}" @if (in_array($layanan->id,
                                old('layanan', $client->layanan->pluck('id')->toArray()))) checked @endif>
                                <label class="form-check-label">{{ $layanan->nama_layanan }}</label>
                            </div>
                            @endforeach
                            @error('layanan')
