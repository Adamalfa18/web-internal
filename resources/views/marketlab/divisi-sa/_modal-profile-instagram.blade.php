                    ...
                    <div class="mb-3">
                        ...
                        <div id="ig-links-container" class="mt-2">
                            ...
                            <div class="mb-2 row align-items-center">
                                <div class="col-md-5">
                                    <input class="form-control mb-1" name="links[{{ $index }}][url]" placeholder="URL"
                                ...
                                <div class="col-md-2 d-flex align-items-center">
                                    <button type="button" class="btn btn-danger btn-sm remove-link-btn" {{ $isDisabled
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                @if (!$profileIG)
                <div class="alert alert-warning">Profile Not added yet. Please fill in for
                ...
                <form action="{{ route('divisi-sa.updateProfile', ['client_id' => $client_id]) }}" method="POST"
                    ...
                    <div class="mb-3">
                        <label>Name</label>
                        <input type="text" name="name" class="form-control" required value="{{ $profileIG->name }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="links-container-modal">
                            ...
                            <div class="mb-2 row align-items-center">
                                <div class="col-md-5">
                                    <input name="links[{{ $index }}][url]" class="form-control" value="{{ $link->url }}"
