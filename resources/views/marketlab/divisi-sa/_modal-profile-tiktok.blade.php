                ...
                <div class="modal-header modal-edit-profile-tiktok">
                    ...
                    <form action="{{ route('divisi-sa.storeProfileTiktok', ['client_id' => $client_id]) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="bio" id="tiktok_bio" rows="3" required {{ $isDisabled
                                }}>{{ $profileTiktok->bio ?? '' }}</textarea>
                        </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="{{ route('divisi-sa.updateProfileTiktok', ['client_id' => $client_id]) }}"
                        ...
                        <div class="mb-3">
                            <label>Link</label>
                            <button type="button" id="add-link-btn-modal-tiktok" class="btn btn-sm btn-primary mb-2">Add
                                Link</button>
