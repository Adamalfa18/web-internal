                            ...
                            <div class="col-md-12">
                                <div class="card-header border-bottom pb-0">
                                    <div class="d-sm-flex align-items-center">
                                        <div>
                                            <h6 class="font-weight-semibold text-lg mb-0">Buat Laporan Harian</h6>
                                            <p class="text-sm">Input Data Harian</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-header border-bottom pb-0">
                                    <form action="{{ route('laporan-harian.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="performance_bulanan_id" class="form-label">Id
                                                        Bulan</label>
                                                    <input type="hidden" name="performance_bulanan_id"
                                                        value="{{ $laporanBulanan->id }}">
                                                    <!-- Menyimpan nilai client_id -->
                                                    <input type="text" class="form-control"
                                                        id="performance_bulanan_id" value="{{ $laporanBulanan->id }}"
                                                        readonly> <!-- Menampilkan nilai tanpa bisa diubah -->
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="hari" class="form-label">Pilih Tanggal</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="total"
                                                        id="total" placeholder="Topup yang di lakukan" required
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="roas" class="form-label">Roas Yang di
                                                        dapatkan</label>
                                                    <input type="text" class="form-control" name="roas"
                                                        id="roas" placeholder="Roas" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div>
                                                    <label class="form-label form-check-label">Pilih Topup</label>
                                                </div>
