                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        @php
                                                                            // Hitung persentase Spent dan Revenue
                                                                            $spent_percent =
                                                                                $spent_harian > 0
                                                                                    ? round(
                                                                                        ($item->total / $spent_harian) *
                                                                                            100,
                                                                                        2,
                                                                                    )
                                                                                    : 0;
                                                                            ...
                                                                            // Default status
                                                                            $spent_status = 'In Progress';
                                                                            $revenue_status = 'In Progress';
                                                                            $spent_color = '#6c757d'; // abu
                                                                            $revenue_color = '#6c757d';
                                                                            ...
                                                                            if (
                                                                                ...
                                                                                $spent_status = 'Underperform';
                                                                                $spent_color = '#ff0000'; // merah
                                                                            } elseif ($spent_percent == 100) {
                                                                                $spent_status = 'Achieve';
                                                                                $spent_color = '#008000'; // hijau
                                                                            } elseif ($spent_percent < 100) {
                                                                                $spent_status = 'In Progress';
                                                                                $spent_color = '#6c757d'; // abu
                                                                            }

                                                                            // Logika untuk Revenue
                                                                            if (
                                                                                $item->omzet >= $revenue_harian &&
                                                                                $revenue_percent >= 100
                                                                            ) {
                                                                                $revenue_status = 'Excellent';
                                                                                $revenue_color = '#008000'; // hijau
                                                                            } elseif ($revenue_percent < 100) {
                                                                                $revenue_status = 'In Progress';
                                                                                $revenue_color = '#6c757d';
                                                                            }
                                                                        @endphp
                                                                                ...
                                                                                <tr class="border-target">
                                                                                    <td class="align-middle">
                                                                                        <div class="real-roas real-style"
                                                                                            ...
                                                                                            <span
                                                                                                class="text-sm font-weight-normal text-white">
                                                                                                {{ $spent_percent }}%
                                                                                                ({{ $spent_status }})
                                                                                            </span>
                                                                                        </div>
